...
public:
  ...
  WCSimRootCherenkovHitHistory(Int_t nRayScat, Int_t nMieScat, Int_t nRamScat, std::vector<ReflectionSurface_t> refle);
...
public:
  ...
  WCSimRootCherenkovHitHistory   *AddCherenkovHitHistory(Int_t nRayScat, Int_t nRamScat, 
             Int_t nMieScat,
